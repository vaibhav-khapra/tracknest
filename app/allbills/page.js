          ...
          <>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {bills.map((bill) => (
                      <tr key={bill._id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {/* Display the totalAmount directly as it is already calculated in backend */}
                          <div className="font-medium text-gray-900">
                            ₹{Number(bill.totalAmount).toFixed(2)}
                          </div>

                          {/* Display Discount percentage if it exists and is > 0 */}
                          {bill.discount > 0 && (
                          ...
                          {/* Display CGST if it exists and is > 0 */}
                          {bill.cgst > 0 && (
                          ...
                          {/* Display SGST if it exists and is > 0 */}
                          {bill.sgst > 0 && (
                            <span className="text-xs text-gray-400 block">
              ...
              <div className="fixed inset-0 z-50 flex items-start justify-center p-4  overflow-y-auto">
                ...
                <div className="relative w-full max-w-2xl rounded-lg bg-white p-6 shadow-xl border border-gray-200 ">
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-gray-100 text-left">
                          <th className="py-2 px-4 font-semibold text-gray-700 border-b">
                            Item
                          </th>
                          <th className="py-2 px-4 font-semibold text-gray-700 border-b text-right">
                            Price
                          </th>
                          <th className="py-2 px-4 font-semibold text-gray-700 border-b text-right">
                            Qty
                  ...
                  <div className="mt-8 pt-4 border-t border-gray-300 text-center text-sm text-gray-500">
                    ...
                    {user.ownerName && (
                      <p className="mt-2">Proprietor: {user.ownerName}</p>
                    )}
                  </div>
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="text-sm text-gray-500">
                ...
                of {pagination.totalBills} bills
              </div>
              <div className="flex space-x-2">
                <button
